                        ...
                        <form onSubmit={criarJogo} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            <div style={{ display: 'flex', gap: '8px', alignItems: 'center', width: '100%' }}>
                                <input
                                    ...
                                    style={{ flex: 1, minWidth: 0, padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0', boxSizing: 'border-box', textAlign: 'center', fontSize: '15px' }}
                                    required
                                />
                            ...
                            <button className="btn-primary" disabled={loading} style={{ background: '#0f172a', width: '100%', margin: 0 }}>
